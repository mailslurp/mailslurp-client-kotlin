...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **contactId** | [**java.util.UUID**](.md)| contactId |
...
# **getContacts**
> kotlin.Array&lt;ContactProjection&gt; getContacts()
...
val apiInstance = ContactControllerApi()
try {
    val result : kotlin.Array<ContactProjection> = apiInstance.getContacts()
    println(result)
} catch (e: ClientException) {
...
[**kotlin.Array&lt;ContactProjection&gt;**](ContactProjection.md)
