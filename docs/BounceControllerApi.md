...
try {
    val result : Bounce = apiInstance.getBouncedEmail(id)
    println(result)
...
try {
    val result : PageBouncedEmail = apiInstance.getBouncedEmails(page, size, sort)
    println(result)
} catch (e: ClientException) {
...
try {
    val result : BounceRecipient = apiInstance.getBouncedRecipient(id)
    println(result)
} catch (e: ClientException) {
...
val sort : kotlin.String = sort_example // kotlin.String | Optional createdAt sort direction ASC or DESC
try {
    val result : PageBouncedRecipients = apiInstance.getBouncedRecipients(page, size, sort)
    println(result)
} catch (e: ClientException) {
