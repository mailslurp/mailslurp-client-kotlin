...
<a name="waitFor"></a>
# **waitFor**
> kotlin.Array&lt;EmailPreview&gt; waitFor(waitForConditions)
...
val waitForConditions : WaitForConditions =  // WaitForConditions | Conditions to wait for
try {
    val result : kotlin.Array<EmailPreview> = apiInstance.waitFor(waitForConditions)
    println(result)
...
# **waitForEmailCount**
> kotlin.Array&lt;EmailPreview&gt; waitForEmailCount(count, inboxId, timeout, unreadOnly)
...
try {
    val result : kotlin.Array<EmailPreview> = apiInstance.waitForEmailCount(count, inboxId, timeout, unreadOnly)
    println(result)
} catch (e: ClientException) {
 ...
 **inboxId** | [**java.util.UUID**](.md)| Id of the inbox we are fetching emails from | [optional]
...
> kotlin.Array&lt;EmailPreview&gt; waitForMatchingEmail(matchOptions, count, inboxId, timeout, unreadOnly)
...
val unreadOnly : kotlin.Boolean = true // kotlin.Boolean | Optional filter for unread only
try {
    val result : kotlin.Array<EmailPreview> = apiInstance.waitForMatchingEmail(matchOptions, count, inboxId, timeout, unreadOnly)
    println(result)
} catch (e: ClientException) {
...
------------- | ------------- | ------------- | -------------
 **matchOptions** | [**MatchOptions**](MatchOptions.md)| matchOptions |
 **inboxId** | [**java.util.UUID**](.md)| Id of the inbox we are matching an email for | [optional]
 **timeout** | **kotlin.Long**| Max milliseconds to wait | [optional]
 **unreadOnly** | **kotlin.Boolean**| Optional filter for unread only | [optional] [default to false]
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **inboxId** | [**java.util.UUID**](.md)| Id of the inbox you are fetching emails from | [optional]
