...
------------- | ------------- | ------------- | -------------
 **inboxId** | [**java.util.UUID**](.md)| ID of inbox you want to retrieve (not the inbox ID) |
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **expiredId** | [**java.util.UUID**](.md)| ID of the ExpiredInboxRecord you want to retrieve. This is different from the ID of the inbox you are interested in. See other methods for getting ExpiredInboxRecord for an inbox inboxId) |
...
try {
    val result : PageExpiredInboxRecordProjection = apiInstance.getExpiredInboxes(page, size, sort)
    println(result)
} catch (e: ClientException) {
