...
val createWebhookOptions : CreateWebhookOptions =  // CreateWebhookOptions | 
try {
    val result : WebhookDto = apiInstance.createWebhookForPhoneNumber(phoneNumberId, createWebhookOptions)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling WebhookControllerApi#createWebhookForPhoneNumber")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling WebhookControllerApi#createWebhookForPhoneNumber")
    e.printStackTrace()
}
```
...
val eventType : kotlin.String = eventType_example // kotlin.String | Optional event type
...
try {
    val result : PageWebhookProjection = apiInstance.getAllAccountWebhooks(page, size, sort, eventType, since, before)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling WebhookControllerApi#getAllAccountWebhooks")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling WebhookControllerApi#getAllAccountWebhooks")
    e.printStackTrace()
}
```
 ...
 **eventType** | **kotlin.String**| Optional event type | [optional] [enum: EMAIL_RECEIVED, NEW_EMAIL, NEW_CONTACT, NEW_ATTACHMENT, EMAIL_OPENED, EMAIL_READ, DELIVERY_STATUS, BOUNCE, BOUNCE_RECIPIENT, NEW_SMS]
...
val searchFilter : kotlin.String = searchFilter_example // kotlin.String | Optional search filter
val since : java.time.OffsetDateTime = 2013-10-20T19:20:30+01:00 // java.time.OffsetDateTime | Filter by created at after the given timestamp
val inboxId : java.util.UUID = 38400000-8cf0-11bd-b23e-10b96e4ef00d // java.util.UUID | Filter by inboxId
val phoneId : java.util.UUID = 38400000-8cf0-11bd-b23e-10b96e4ef00d // java.util.UUID | Filter by phoneId
val before : java.time.OffsetDateTime = 2013-10-20T19:20:30+01:00 // java.time.OffsetDateTime | Filter by created at before the given timestamp
try {
    val result : PageWebhookProjection = apiInstance.getAllWebhooks(page, size, sort, searchFilter, since, inboxId, phoneId, before)
    println(result)
} catch (e: ClientException) {
 ...
 **searchFilter** | **kotlin.String**| Optional search filter | [optional]
 **since** | **java.time.OffsetDateTime**| Filter by created at after the given timestamp | [optional]
 **inboxId** | [**java.util.UUID**]()| Filter by inboxId | [optional]
 **phoneId** | [**java.util.UUID**]()| Filter by phoneId | [optional]
 **before** | **java.time.OffsetDateTime**| Filter by created at before the given timestamp | [optional]
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **event** | **kotlin.String**|  | [enum: EMAIL_RECEIVED, NEW_EMAIL, NEW_CONTACT, NEW_ATTACHMENT, EMAIL_OPENED, EMAIL_READ, DELIVERY_STATUS, BOUNCE, BOUNCE_RECIPIENT, NEW_SMS]
...
val apiInstance = WebhookControllerApi()
val phoneId : java.util.UUID = 38400000-8cf0-11bd-b23e-10b96e4ef00d // java.util.UUID | 
val page : kotlin.Int = 56 // kotlin.Int | Optional page index in list pagination
val size : kotlin.Int = 56 // kotlin.Int | Optional page size in list pagination
val sort : kotlin.String = sort_example // kotlin.String | Optional createdAt sort direction ASC or DESC
val since : java.time.OffsetDateTime = 2013-10-20T19:20:30+01:00 // java.time.OffsetDateTime | Filter by created at after the given timestamp
val before : java.time.OffsetDateTime = 2013-10-20T19:20:30+01:00 // java.time.OffsetDateTime | Filter by created at before the given timestamp
try {
    val result : PageWebhookProjection = apiInstance.getPhoneNumberWebhooksPaginated(phoneId, page, size, sort, since, before)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling WebhookControllerApi#getPhoneNumberWebhooksPaginated")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling WebhookControllerApi#getPhoneNumberWebhooksPaginated")
    e.printStackTrace()
}
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **eventName** | **kotlin.String**|  | [optional] [enum: EMAIL_RECEIVED, NEW_EMAIL, NEW_CONTACT, NEW_ATTACHMENT, EMAIL_OPENED, EMAIL_READ, DELIVERY_STATUS, BOUNCE, BOUNCE_RECIPIENT, NEW_SMS]
...
val apiInstance = WebhookControllerApi()
try {
    val result : WebhookDeliveryStatusPayload = apiInstance.getTestWebhookPayloadDeliveryStatus()
    println(result)
} catch (e: ClientException) {
    println("4xx response calling WebhookControllerApi#getTestWebhookPayloadDeliveryStatus")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling WebhookControllerApi#getTestWebhookPayloadDeliveryStatus")
    e.printStackTrace()
}
```
...
val apiInstance = WebhookControllerApi()
try {
    val result : WebhookNewSmsPayload = apiInstance.getTestWebhookPayloadNewSms()
    println(result)
} catch (e: ClientException) {
    println("4xx response calling WebhookControllerApi#getTestWebhookPayloadNewSms")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling WebhookControllerApi#getTestWebhookPayloadNewSms")
    e.printStackTrace()
}
```
