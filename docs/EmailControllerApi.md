...
[**kotlin.Array&lt;AttachmentMetaData&gt;**](AttachmentMetaData)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **inboxId** | [**kotlin.Array&lt;java.util.UUID&gt;**](java.util.UUID)| Optional inbox ids to filter by. Can be repeated. By default will use all inboxes belonging to your account. | [optional]
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **inboxIds** | [**kotlin.Array&lt;java.util.UUID&gt;**](java.util.UUID)| Optional set of inboxes to filter by. Only get the latest email from these inbox IDs | [optional]
