...
------------- | ------------- | ------------- | -------------
 **emailId** | [**java.util.UUID**](.md)| ID of email to delete |
...
# **downloadAttachment**
> kotlin.ByteArray downloadAttachment(attachmentId, emailId, apiKey)
...
try {
    val result : kotlin.ByteArray = apiInstance.downloadAttachment(attachmentId, emailId, apiKey)
    println(result)
} catch (e: ClientException) {
 ...
 **emailId** | [**java.util.UUID**](.md)| ID of email |
...
val emailId : java.util.UUID = 38400000-8cf0-11bd-b23e-10b96e4ef00d // java.util.UUID | ID of email
try {
    val result : DownloadAttachmentDto = apiInstance.downloadAttachmentBase64(attachmentId, emailId)
    println(result)
} catch (e: ClientException) {
...
val apiInstance = EmailControllerApi()
val emailId : java.util.UUID = 38400000-8cf0-11bd-b23e-10b96e4ef00d // java.util.UUID | ID of email
val forwardEmailOptions : ForwardEmailOptions =  // ForwardEmailOptions | forwardEmailOptions
try {
...
val emailId : java.util.UUID = 38400000-8cf0-11bd-b23e-10b96e4ef00d // java.util.UUID | ID of email
try {
    val result : AttachmentMetaData = apiInstance.getAttachmentMetaData(attachmentId, emailId)
    println(result)
} catch (e: ClientException) {
...
# **getAttachments**
> kotlin.Array&lt;AttachmentMetaData&gt; getAttachments(emailId)
...
val emailId : java.util.UUID = 38400000-8cf0-11bd-b23e-10b96e4ef00d // java.util.UUID | ID of email
try {
    val result : kotlin.Array<AttachmentMetaData> = apiInstance.getAttachments(emailId)
    println(result)
} catch (e: ClientException) {
...
[**kotlin.Array&lt;AttachmentMetaData&gt;**](AttachmentMetaData.md)
...
val apiInstance = EmailControllerApi()
val emailId : java.util.UUID = 38400000-8cf0-11bd-b23e-10b96e4ef00d // java.util.UUID | emailId
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **emailId** | [**java.util.UUID**](.md)| emailId |
...
val contentMatchOptions : ContentMatchOptions =  // ContentMatchOptions | contentMatchOptions
try {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **emailId** | [**java.util.UUID**](.md)| ID of email to match against |
...
val apiInstance = EmailControllerApi()
val emailId : java.util.UUID = 38400000-8cf0-11bd-b23e-10b96e4ef00d // java.util.UUID | emailId
val decode : kotlin.Boolean = true // kotlin.Boolean | decode
try {
...
------------- | ------------- | ------------- | -------------
 **emailId** | [**java.util.UUID**](.md)| emailId |
 **decode** | **kotlin.Boolean**| decode | [optional] [default to false]
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **emailId** | [**java.util.UUID**](.md)| ID of email to perform HTML query on |
 **htmlSelector** | **kotlin.String**| HTML selector to search for. Uses JQuery/JSoup/CSS style selector like &#39;.my-div&#39; to match content. See https://jsoup.org/apidocs/org/jsoup/select/Selector.html for more information. | [optional]
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **emailId** | [**java.util.UUID**](.md)| ID of email to fetch text for |
...
val apiInstance = EmailControllerApi()
val inboxId : kotlin.Array<java.util.UUID> =  // kotlin.Array<java.util.UUID> | Optional inbox ids to filter by. Can be repeated. By default will use all inboxes belonging to your account.
...
try {
    val result : PageEmailProjection = apiInstance.getEmailsPaginated(inboxId, page, size, sort, unreadOnly)
    println(result)
} catch (e: ClientException) {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **inboxId** | [**kotlin.Array&lt;java.util.UUID&gt;**](java.util.UUID.md)| Optional inbox ids to filter by. Can be repeated. By default will use all inboxes belonging to your account. | [optional]
...
val apiInstance = EmailControllerApi()
val inboxIds : kotlin.Array<java.util.UUID> =  // kotlin.Array<java.util.UUID> | Optional set of inboxes to filter by. Only get the latest email from these inbox IDs
try {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **inboxIds** | [**kotlin.Array&lt;java.util.UUID&gt;**](java.util.UUID.md)| Optional set of inboxes to filter by. Only get the latest email from these inbox IDs | [optional]
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **inboxId** | [**java.util.UUID**](.md)| ID of the inbox you want to get the latest email from | [optional]
...
val unreadOnly : kotlin.Boolean = true // kotlin.Boolean | Optional filter for unread emails only. All emails are considered unread until they are viewed in the dashboard or requested directly
try {
    val result : PageEmailProjection = apiInstance.getOrganizationEmailsPaginated(inboxId, page, size, sort, unreadOnly)
    println(result)
} catch (e: ClientException) {
...
val replyToEmailOptions : ReplyToEmailOptions =  // ReplyToEmailOptions | replyToEmailOptions
try {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **emailId** | [**java.util.UUID**](.md)| ID of the email that should be replied to |
