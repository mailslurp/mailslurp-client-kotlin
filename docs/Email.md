...
**userId** | [**java.util.UUID**](java.util.UUID) | ID of user that email belongs to | 
**inboxId** | [**java.util.UUID**](java.util.UUID) | ID of the inbox that received the email | 
...
**updatedAt** | [**java.time.OffsetDateTime**](java.time.OffsetDateTime) | When was the email last updated | 
