...
try {
    val result : MissedEmail = apiInstance.waitForNthMissedEmail(inboxId, timeout, index)
    println(result)
} catch (e: ClientException) {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **inboxId** | [**java.util.UUID**]()| Optional inbox ID filter |
 **timeout** | **kotlin.Long**| Optional timeout milliseconds |
