...
val favourite : kotlin.Boolean = true // kotlin.Boolean | favourite
val inboxType : kotlin.String = inboxType_example // kotlin.String | inboxType
val name : kotlin.String = name_example // kotlin.String | name
val tags : kotlin.collections.List<kotlin.String> =  // kotlin.collections.List<kotlin.String> | tags
val useDomainPool : kotlin.Boolean = true // kotlin.Boolean | useDomainPool
try {
    val result : Inbox = apiInstance.createNewEmailAddress(allowTeamAccess, description, emailAddress, expiresAt, expiresIn, favourite, inboxType, name, tags, useDomainPool)
    println(result)
 ...
 **emailAddress** | **kotlin.String**| emailAddress | [optional]
 **expiresAt** | **java.time.OffsetDateTime**| expiresAt | [optional]
 **expiresIn** | **kotlin.Long**| expiresIn | [optional]
 **favourite** | **kotlin.Boolean**| favourite | [optional]
 **inboxType** | **kotlin.String**| inboxType | [optional] [enum: HTTP_INBOX, SMTP_INBOX]
 **name** | **kotlin.String**| name | [optional]
 **tags** | [**kotlin.collections.List&lt;kotlin.String&gt;**](kotlin.String)| tags | [optional]
...
val useDomainPool : kotlin.Boolean = true // kotlin.Boolean | useDomainPool
try {
    val result : Inbox = apiInstance.createNewEmailAddress1(allowTeamAccess, description, emailAddress, expiresAt, expiresIn, favourite, inboxType, name, tags, useDomainPool)
    println(result)
} catch (e: ClientException) {
