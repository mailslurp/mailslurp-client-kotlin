 ...
 **tags** | [**kotlin.collections.Set&lt;kotlin.String&gt;**](kotlin.String)|  | [optional]
...
val favourite : kotlin.Boolean = true // kotlin.Boolean | 
try {
    val result : InboxDto = apiInstance.createNewEmailAddress1(allowTeamAccess, useDomainPool, expiresAt, expiresIn, emailAddress, inboxType, description, name, tags, favourite)
    println(result)
} catch (e: ClientException) {
