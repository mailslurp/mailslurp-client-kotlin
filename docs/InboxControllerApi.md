...
<a name="getEmails"></a>
# **getEmails**
> kotlin.collections.List&lt;EmailPreview&gt; getEmails(inboxId, limit, minCount, retryTimeout, since, size, sort)
...
try {
    val result : kotlin.collections.List<EmailPreview> = apiInstance.getEmails(inboxId, limit, minCount, retryTimeout, since, size, sort)
    println(result)
} catch (e: ClientException) {
