...
val allowTeamAccess : kotlin.Boolean = true // kotlin.Boolean | Grant team access to this inbox and the emails that belong to it for team members of your organization.
...
val favourite : kotlin.Boolean = true // kotlin.Boolean | Is the inbox favorited. Favouriting inboxes is typically done in the dashboard for quick access or filtering
val name : kotlin.String = name_example // kotlin.String | Optional name of the inbox. Displayed in the dashboard for easier search
val tags : kotlin.Array<kotlin.String> =  // kotlin.Array<kotlin.String> | Tags that inbox has been tagged with. Tags can be added to inboxes to group different inboxes within an account. You can also search for inboxes by tag in the dashboard UI.
...
try {
    val result : Inbox = apiInstance.createInbox(allowTeamAccess, description, emailAddress, expiresAt, expiresIn, favourite, name, tags, useDomainPool)
    println(result)
 ...
 **tags** | [**kotlin.Array&lt;kotlin.String&gt;**](kotlin.String.md)| Tags that inbox has been tagged with. Tags can be added to inboxes to group different inboxes within an account. You can also search for inboxes by tag in the dashboard UI. | [optional]
...
val apiInstance = InboxControllerApi()
val createInboxDto : CreateInboxDto =  // CreateInboxDto | createInboxDto
try {
    val result : Inbox = apiInstance.createInboxWithOptions(createInboxDto)
    println(result)
} catch (e: ClientException) {
...
val teamAccess : kotlin.Boolean = true // kotlin.Boolean | Optionally filter by team access. Defaults to false so organization inboxes are not included
try {
    val result : PageInboxProjection = apiInstance.getAllInboxes(favourite, page, search, size, sort, tag, teamAccess)
    println(result)
} catch (e: ClientException) {
 ...
 **teamAccess** | **kotlin.Boolean**| Optionally filter by team access. Defaults to false so organization inboxes are not included | [optional] [default to false]
...
<a name="getEmails"></a>
# **getEmails**
> kotlin.Array&lt;EmailPreview&gt; getEmails(inboxId, limit, minCount, retryTimeout, since, size, sort)
...
try {
    val result : kotlin.Array<EmailPreview> = apiInstance.getEmails(inboxId, limit, minCount, retryTimeout, since, size, sort)
    println(result)
} catch (e: ClientException) {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **inboxId** | [**java.util.UUID**](.md)| Id of inbox that emails belongs to |
...
[**kotlin.Array&lt;EmailPreview&gt;**](EmailPreview.md)
...
val inboxId : java.util.UUID = 38400000-8cf0-11bd-b23e-10b96e4ef00d // java.util.UUID | inboxId
try {
    val result : Inbox = apiInstance.getInbox(inboxId)
    println(result)
} catch (e: ClientException) {
...
val sort : kotlin.String = sort_example // kotlin.String | Optional createdAt sort direction ASC or DESC
try {
    val result : PageEmailPreview = apiInstance.getInboxEmailsPaginated(inboxId, page, size, sort)
    println(result)
} catch (e: ClientException) {
...
val sort : kotlin.String = sort_example // kotlin.String | Optional createdAt sort direction ASC or DESC
try {
    val result : PageSentEmailProjection = apiInstance.getInboxSentEmails(inboxId, page, size, sort)
    println(result)
} catch (e: ClientException) {
...
# **getInboxTags**
> kotlin.Array&lt;kotlin.String&gt; getInboxTags()
...
val apiInstance = InboxControllerApi()
try {
    val result : kotlin.Array<kotlin.String> = apiInstance.getInboxTags()
    println(result)
} catch (e: ClientException) {
...
<a name="getInboxes"></a>
# **getInboxes**
> kotlin.Array&lt;Inbox&gt; getInboxes(size, sort)
...
val sort : kotlin.String = sort_example // kotlin.String | Optional createdAt sort direction ASC or DESC
try {
    val result : kotlin.Array<Inbox> = apiInstance.getInboxes(size, sort)
    println(result)
} catch (e: ClientException) {
...
val sort : kotlin.String = sort_example // kotlin.String | Optional createdAt sort direction ASC or DESC
try {
    val result : PageOrganizationInboxProjection = apiInstance.getOrganizationInboxes(page, size, sort)
    println(result)
} catch (e: ClientException) {
...
val sendEmailOptions : SendEmailOptions =  // SendEmailOptions | Options for the email
try {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **inboxId** | [**java.util.UUID**](.md)| ID of the inbox you want to send the email from |
...
val apiInstance = InboxControllerApi()
val inboxId : java.util.UUID = 38400000-8cf0-11bd-b23e-10b96e4ef00d // java.util.UUID | inboxId
val setInboxFavouritedOptions : SetInboxFavouritedOptions =  // SetInboxFavouritedOptions | setInboxFavouritedOptions
try {
    val result : Inbox = apiInstance.setInboxFavourited(inboxId, setInboxFavouritedOptions)
    println(result)
} catch (e: ClientException) {
...
val apiInstance = InboxControllerApi()
val inboxId : java.util.UUID = 38400000-8cf0-11bd-b23e-10b96e4ef00d // java.util.UUID | inboxId
val updateInboxOptions : UpdateInboxOptions =  // UpdateInboxOptions | updateInboxOptions
try {
    val result : Inbox = apiInstance.updateInbox(inboxId, updateInboxOptions)
    println(result)
} catch (e: ClientException) {
