...
val inboxType : kotlin.String = inboxType_example // kotlin.String | HTTP (default) or SMTP inbox type. HTTP inboxes are best for testing while SMTP inboxes are more reliable for public inbound email consumption. When using custom domains the domain type must match the inbox type. HTTP inboxes are processed by AWS SES while SMTP inboxes use a custom mail server running at `mx.mailslurp.com`.
...
try {
    val result : Inbox = apiInstance.createInbox(allowTeamAccess, description, emailAddress, expiresAt, expiresIn, favourite, inboxType, name, tags, useDomainPool)
    println(result)
...
val apiInstance = InboxControllerApi()
try {
    val result : Inbox = apiInstance.createInboxWithDefaults()
    println(result)
} catch (e: ClientException) {
...
<a name="getEmails"></a>
# **getEmails**
> kotlin.collections.List&lt;EmailPreview&gt; getEmails(inboxId, delayTimeout, limit, minCount, retryTimeout, since, size, sort, unreadOnly)
...
val delayTimeout : kotlin.Long = 789 // kotlin.Long | delayTimeout
...
val unreadOnly : kotlin.Boolean = true // kotlin.Boolean | unreadOnly
try {
    val result : kotlin.collections.List<EmailPreview> = apiInstance.getEmails(inboxId, delayTimeout, limit, minCount, retryTimeout, since, size, sort, unreadOnly)
    println(result)
} catch (e: ClientException) {
 ...
 **delayTimeout** | **kotlin.Long**| delayTimeout | [optional]
 ...
 **unreadOnly** | **kotlin.Boolean**| unreadOnly | [optional]
...
val sort : kotlin.String = sort_example // kotlin.String | Optional createdAt sort direction ASC or DESC
try {
    val result : PageSentEmailProjection = apiInstance.getInboxSentEmails(inboxId, page, searchFilter, size, sort)
    println(result)
} catch (e: ClientException) {
...
<a name="getInboxes"></a>
# **getInboxes**
> kotlin.collections.List&lt;Inbox&gt; getInboxes(size, sort)
...
val sort : kotlin.String = sort_example // kotlin.String | Optional createdAt sort direction ASC or DESC
try {
    val result : kotlin.collections.List<Inbox> = apiInstance.getInboxes(size, sort)
    println(result)
} catch (e: ClientException) {
...
val sort : kotlin.String = sort_example // kotlin.String | Optional createdAt sort direction ASC or DESC
try {
    val result : PageOrganizationInboxProjection = apiInstance.getOrganizationInboxes(page, searchFilter, size, sort)
    println(result)
} catch (e: ClientException) {
...
val sort : kotlin.String = sort_example // kotlin.String | Optional createdAt sort direction ASC or DESC
try {
    val result : PageInboxRulesetDto = apiInstance.listInboxRulesets(inboxId, page, searchFilter, size, sort)
    println(result)
} catch (e: ClientException) {
...
val sort : kotlin.String = sort_example // kotlin.String | Optional createdAt sort direction ASC or DESC
try {
    val result : PageTrackingPixelProjection = apiInstance.listInboxTrackingPixels(inboxId, page, searchFilter, size, sort)
    println(result)
} catch (e: ClientException) {
