...
------------- | ------------- | ------------- | -------------
 **groupId** | [**java.util.UUID**](.md)| groupId |
...
<a name="getGroups"></a>
# **getGroups**
> kotlin.Array&lt;GroupProjection&gt; getGroups()
...
val apiInstance = GroupControllerApi()
try {
    val result : kotlin.Array<GroupProjection> = apiInstance.getGroups()
    println(result)
} catch (e: ClientException) {
...
[**kotlin.Array&lt;GroupProjection&gt;**](GroupProjection.md)
