...
class WaitForControllerApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    companion object {
        @JvmStatic
    ...
    */
    ...
    fun waitFor(waitForConditions: WaitForConditions?) : kotlin.Array<EmailPreview> {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun waitForEmailCount(count: kotlin.Int?, inboxId: java.util.UUID?, timeout: kotlin.Long?, unreadOnly: kotlin.Boolean?) : kotlin.Array<EmailPreview> {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun waitForMatchingEmail(matchOptions: MatchOptions, count: kotlin.Int?, inboxId: java.util.UUID?, timeout: kotlin.Long?, unreadOnly: kotlin.Boolean?) : kotlin.Array<EmailPreview> {
