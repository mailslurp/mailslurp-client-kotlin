...
class WaitForControllerApi(private val xApiKey: kotlin.String, basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun waitForMatchingEmail(matchOptions: MatchOptions, count: kotlin.Int?, delay: kotlin.Long?, inboxId: java.util.UUID?, since: java.time.OffsetDateTime?, sort: kotlin.String?, timeout: kotlin.Long?, unreadOnly: kotlin.Boolean?) : kotlin.collections.List<EmailPreview> {
        val localVariableConfig = waitForMatchingEmailRequestConfig(matchOptions = matchOptions, count = count, delay = delay, inboxId = inboxId, since = since, sort = sort, timeout = timeout, unreadOnly = unreadOnly)
    ...
    * @return RequestConfig
    */
    fun waitForMatchingEmailRequestConfig(matchOptions: MatchOptions, count: kotlin.Int?, delay: kotlin.Long?, inboxId: java.util.UUID?, since: java.time.OffsetDateTime?, sort: kotlin.String?, timeout: kotlin.Long?, unreadOnly: kotlin.Boolean?) : RequestConfig {
