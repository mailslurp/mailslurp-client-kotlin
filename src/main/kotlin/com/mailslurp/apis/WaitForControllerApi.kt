...
class WaitForControllerApi(private val xApiKey: kotlin.String, basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun waitForLatestSms(waitForSingleSmsOptions: WaitForSingleSmsOptions) : SmsDto {
        val localVariableConfig = waitForLatestSmsRequestConfig(waitForSingleSmsOptions = waitForSingleSmsOptions)
    ...
    * @return RequestConfig
    */
    fun waitForLatestSmsRequestConfig(waitForSingleSmsOptions: WaitForSingleSmsOptions) : RequestConfig {
        val localVariableBody: kotlin.Any? = waitForSingleSmsOptions
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("x-api-key" to xApiKey)
    ...
    * @return kotlin.collections.List<SmsPreview>
    * @throws UnsupportedOperationException If the API returns an informational or redirection response
    * @throws ClientException If the API returns a client error response
    * @throws ServerException If the API returns a server error response
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun waitForSms(waitForSmsConditions: WaitForSmsConditions) : kotlin.collections.List<SmsPreview> {
        val localVariableConfig = waitForSmsRequestConfig(waitForSmsConditions = waitForSmsConditions)

        val localVarResponse = request<kotlin.collections.List<SmsPreview>>(
            localVariableConfig
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as kotlin.collections.List<SmsPreview>
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    * @return RequestConfig
    */
    fun waitForSmsRequestConfig(waitForSmsConditions: WaitForSmsConditions) : RequestConfig {
        val localVariableBody: kotlin.Any? = waitForSmsConditions
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("x-api-key" to xApiKey)
