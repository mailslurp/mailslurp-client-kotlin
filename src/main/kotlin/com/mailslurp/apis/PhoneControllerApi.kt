...
class PhoneControllerApi(private val xApiKey: kotlin.String, basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun testPhoneNumberSendSms(phoneNumberId: java.util.UUID, testPhoneNumberOptions: TestPhoneNumberOptions) : Unit {
        val localVariableConfig = testPhoneNumberSendSmsRequestConfig(phoneNumberId = phoneNumberId, testPhoneNumberOptions = testPhoneNumberOptions)
    ...
    * @return RequestConfig
    */
    fun testPhoneNumberSendSmsRequestConfig(phoneNumberId: java.util.UUID, testPhoneNumberOptions: TestPhoneNumberOptions) : RequestConfig {
