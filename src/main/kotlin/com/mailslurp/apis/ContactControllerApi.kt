...
class ContactControllerApi(private val xApiKey: kotlin.String, basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    ...
    fun getAllContacts(page: kotlin.Int?, size: kotlin.Int?, sort: kotlin.String?) : PageContactProjection {
        val localVariableConfig = getAllContactsRequestConfig(page = page, size = size, sort = sort)
    ...
    * @return RequestConfig
    */
    fun getAllContactsRequestConfig(page: kotlin.Int?, size: kotlin.Int?, sort: kotlin.String?) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getContactVCard(contactId: java.util.UUID) : kotlin.ByteArray {
