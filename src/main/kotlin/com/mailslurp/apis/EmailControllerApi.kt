...
class EmailControllerApi(private val xApiKey: kotlin.String, basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    ...
    fun applyImapFlagOperation(emailId: java.util.UUID, imapFlagOperationOptions: ImapFlagOperationOptions) : EmailPreview {
        val localVariableConfig = applyImapFlagOperationRequestConfig(emailId = emailId, imapFlagOperationOptions = imapFlagOperationOptions)
    ...
    /**
    * To obtain the request config of the operation applyImapFlagOperation
    *
    * @param emailId  
    * @param imapFlagOperationOptions  
    * @return RequestConfig
    */
    fun applyImapFlagOperationRequestConfig(emailId: java.util.UUID, imapFlagOperationOptions: ImapFlagOperationOptions) : RequestConfig {
        val localVariableBody: kotlin.Any? = imapFlagOperationOptions
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("x-api-key" to xApiKey)
        
        val localVariableConfig = RequestConfig(
            method = RequestMethod.POST,
            path = "/emails/{emailId}/imap-flag-operation".replace("{"+"emailId"+"}", "$emailId"),
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun downloadAttachment(emailId: java.util.UUID, attachmentId: kotlin.String, apiKey: kotlin.String?) : kotlin.ByteArray {
        val localVariableConfig = downloadAttachmentRequestConfig(emailId = emailId, attachmentId = attachmentId, apiKey = apiKey)
    ...
    * @return RequestConfig
    */
    fun downloadAttachmentRequestConfig(emailId: java.util.UUID, attachmentId: kotlin.String, apiKey: kotlin.String?) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        ...
        val localVariableConfig = RequestConfig(
            ...
            path = "/emails/{emailId}/attachments/{attachmentId}".replace("{"+"emailId"+"}", "$emailId").replace("{"+"attachmentId"+"}", "$attachmentId"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun downloadAttachmentBase64(emailId: java.util.UUID, attachmentId: kotlin.String) : DownloadAttachmentDto {
        val localVariableConfig = downloadAttachmentBase64RequestConfig(emailId = emailId, attachmentId = attachmentId)
    ...
    * @return RequestConfig
    */
    fun downloadAttachmentBase64RequestConfig(emailId: java.util.UUID, attachmentId: kotlin.String) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("x-api-key" to xApiKey)
        ...
        val localVariableConfig = RequestConfig(
            method = RequestMethod.GET,
            path = "/emails/{emailId}/attachments/{attachmentId}/base64".replace("{"+"emailId"+"}", "$emailId").replace("{"+"attachmentId"+"}", "$attachmentId"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getAttachmentMetaData(emailId: java.util.UUID, attachmentId: kotlin.String) : AttachmentMetaData {
        val localVariableConfig = getAttachmentMetaDataRequestConfig(emailId = emailId, attachmentId = attachmentId)
    ...
    * @return RequestConfig
    */
    fun getAttachmentMetaDataRequestConfig(emailId: java.util.UUID, attachmentId: kotlin.String) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("x-api-key" to xApiKey)
        ...
        val localVariableConfig = RequestConfig(
            method = RequestMethod.GET,
            path = "/emails/{emailId}/attachments/{attachmentId}/metadata".replace("{"+"emailId"+"}", "$emailId").replace("{"+"attachmentId"+"}", "$attachmentId"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getEmailAttachments(emailId: java.util.UUID) : kotlin.collections.List<AttachmentMetaData> {
        val localVariableConfig = getEmailAttachmentsRequestConfig(emailId = emailId)
    ...
    /**
    * To obtain the request config of the operation getEmailAttachments
    *
    * @param emailId ID of email 
    * @return RequestConfig
    */
    fun getEmailAttachmentsRequestConfig(emailId: java.util.UUID) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("x-api-key" to xApiKey)
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getEmailCount() : CountDto {
        val localVariableConfig = getEmailCountRequestConfig()
    ...
    * @return RequestConfig
    */
    fun getEmailCountRequestConfig() : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("x-api-key" to xApiKey)
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getEmailHTMLJson(emailId: java.util.UUID, decode: kotlin.Boolean?) : EmailHtmlDto {
        val localVariableConfig = getEmailHTMLJsonRequestConfig(emailId = emailId, decode = decode)

        val localVarResponse = request<EmailHtmlDto>(
            localVariableConfig
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as EmailHtmlDto
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    /**
    * To obtain the request config of the operation getEmailHTMLJson
    *
    * @param emailId  
    * @param decode  (optional, default to false)
    * @return RequestConfig
    */
    fun getEmailHTMLJsonRequestConfig(emailId: java.util.UUID, decode: kotlin.Boolean?) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (decode != null) {
        ...
        val localVariableConfig = RequestConfig(
            method = RequestMethod.GET,
            path = "/emails/{emailId}/html/json".replace("{"+"emailId"+"}", "$emailId"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getEmailPreviewURLs(emailId: java.util.UUID) : EmailPreviewUrls {
        val localVariableConfig = getEmailPreviewURLsRequestConfig(emailId = emailId)
    ...
    /**
    * To obtain the request config of the operation getEmailPreviewURLs
    *
    * @param emailId  
    * @return RequestConfig
    */
    fun getEmailPreviewURLsRequestConfig(emailId: java.util.UUID) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("x-api-key" to xApiKey)
        ...
        val localVariableConfig = RequestConfig(
            method = RequestMethod.GET,
            path = "/emails/{emailId}/urls".replace("{"+"emailId"+"}", "$emailId"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getEmailsPaginated(inboxId: kotlin.collections.List<java.util.UUID>?, page: kotlin.Int?, size: kotlin.Int?, sort: kotlin.String?, unreadOnly: kotlin.Boolean?, searchFilter: kotlin.String?, since: java.time.OffsetDateTime?, before: java.time.OffsetDateTime?) : PageEmailProjection {
        val localVariableConfig = getEmailsPaginatedRequestConfig(inboxId = inboxId, page = page, size = size, sort = sort, unreadOnly = unreadOnly, searchFilter = searchFilter, since = since, before = before)
    ...
    * @return RequestConfig
    */
    fun getEmailsPaginatedRequestConfig(inboxId: kotlin.collections.List<java.util.UUID>?, page: kotlin.Int?, size: kotlin.Int?, sort: kotlin.String?, unreadOnly: kotlin.Boolean?, searchFilter: kotlin.String?, since: java.time.OffsetDateTime?, before: java.time.OffsetDateTime?) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (inboxId != null) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getLatestEmailInInbox1(inboxId: java.util.UUID) : Email {
        val localVariableConfig = getLatestEmailInInbox1RequestConfig(inboxId = inboxId)
    ...
    /**
    * To obtain the request config of the operation getLatestEmailInInbox1
    *
    * @param inboxId ID of the inbox you want to get the latest email from 
    * @return RequestConfig
    */
    fun getLatestEmailInInbox1RequestConfig(inboxId: java.util.UUID) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getOrganizationEmailsPaginated(inboxId: kotlin.collections.List<java.util.UUID>?, page: kotlin.Int?, size: kotlin.Int?, sort: kotlin.String?, unreadOnly: kotlin.Boolean?, searchFilter: kotlin.String?, since: java.time.OffsetDateTime?, before: java.time.OffsetDateTime?) : PageEmailProjection {
        val localVariableConfig = getOrganizationEmailsPaginatedRequestConfig(inboxId = inboxId, page = page, size = size, sort = sort, unreadOnly = unreadOnly, searchFilter = searchFilter, since = since, before = before)
    ...
    * @return RequestConfig
    */
    fun getOrganizationEmailsPaginatedRequestConfig(inboxId: kotlin.collections.List<java.util.UUID>?, page: kotlin.Int?, size: kotlin.Int?, sort: kotlin.String?, unreadOnly: kotlin.Boolean?, searchFilter: kotlin.String?, since: java.time.OffsetDateTime?, before: java.time.OffsetDateTime?) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (inboxId != null) {
    ...
    */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun sendEmailSourceOptional(inboxId: java.util.UUID, sendEmailOptions: SendEmailOptions, useDomainPool: kotlin.Boolean?, virtualSend: kotlin.Boolean?) : Unit {
        val localVariableConfig = sendEmailSourceOptionalRequestConfig(inboxId = inboxId, sendEmailOptions = sendEmailOptions, useDomainPool = useDomainPool, virtualSend = virtualSend)
    ...
    * @return RequestConfig
    */
    fun sendEmailSourceOptionalRequestConfig(inboxId: java.util.UUID, sendEmailOptions: SendEmailOptions, useDomainPool: kotlin.Boolean?, virtualSend: kotlin.Boolean?) : RequestConfig {
        ...
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                ...
                if (virtualSend != null) {
                    put("virtualSend", listOf(virtualSend.toString()))
                }
            }
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("x-api-key" to xApiKey)
        ...
        val localVariableConfig = RequestConfig(
            method = RequestMethod.POST,
            path = "/emails".replace("{"+"inboxId"+"}", "$inboxId"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
