...
class EmailControllerApi(private val xApiKey: kotlin.String, basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun sendEmailSourceOptional(sendEmailOptions: SendEmailOptions, inboxId: java.util.UUID?, useDomainPool: kotlin.Boolean?) : Unit {
        val localVariableConfig = sendEmailSourceOptionalRequestConfig(sendEmailOptions = sendEmailOptions, inboxId = inboxId, useDomainPool = useDomainPool)
    ...
    * @return RequestConfig
    */
    fun sendEmailSourceOptionalRequestConfig(sendEmailOptions: SendEmailOptions, inboxId: java.util.UUID?, useDomainPool: kotlin.Boolean?) : RequestConfig {
