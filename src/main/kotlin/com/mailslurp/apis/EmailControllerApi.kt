...
class EmailControllerApi(private val xApiKey: kotlin.String, basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getEmailsPaginated(inboxId: kotlin.collections.List<java.util.UUID>?, page: kotlin.Int?, searchFilter: kotlin.String?, size: kotlin.Int?, sort: kotlin.String?, unreadOnly: kotlin.Boolean?) : PageEmailProjection {
        val localVariableConfig = getEmailsPaginatedRequestConfig(inboxId = inboxId, page = page, searchFilter = searchFilter, size = size, sort = sort, unreadOnly = unreadOnly)
    ...
    * @return RequestConfig
    */
    fun getEmailsPaginatedRequestConfig(inboxId: kotlin.collections.List<java.util.UUID>?, page: kotlin.Int?, searchFilter: kotlin.String?, size: kotlin.Int?, sort: kotlin.String?, unreadOnly: kotlin.Boolean?) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (inboxId != null) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getOrganizationEmailsPaginated(inboxId: kotlin.collections.List<java.util.UUID>?, page: kotlin.Int?, searchFilter: kotlin.String?, size: kotlin.Int?, sort: kotlin.String?, unreadOnly: kotlin.Boolean?) : PageEmailProjection {
        val localVariableConfig = getOrganizationEmailsPaginatedRequestConfig(inboxId = inboxId, page = page, searchFilter = searchFilter, size = size, sort = sort, unreadOnly = unreadOnly)
    ...
    * @return RequestConfig
    */
    fun getOrganizationEmailsPaginatedRequestConfig(inboxId: kotlin.collections.List<java.util.UUID>?, page: kotlin.Int?, searchFilter: kotlin.String?, size: kotlin.Int?, sort: kotlin.String?, unreadOnly: kotlin.Boolean?) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (inboxId != null) {
