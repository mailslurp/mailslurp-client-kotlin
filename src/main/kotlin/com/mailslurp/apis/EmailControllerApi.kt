...
class EmailControllerApi(private val xApiKey: kotlin.String, basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    ...
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun downloadAttachment(emailId: java.util.UUID, attachmentId: kotlin.String, apiKey: kotlin.String?) : kotlin.collections.List<kotlin.ByteArray> {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun downloadBodyBytes(emailId: java.util.UUID) : kotlin.collections.List<kotlin.ByteArray> {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getAttachments(emailId: java.util.UUID) : kotlin.collections.List<AttachmentMetaData> {
        val localVariableConfig = getAttachmentsRequestConfig(emailId = emailId)
    ...
    * @return RequestConfig
    */
    fun getAttachmentsRequestConfig(emailId: java.util.UUID) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("x-api-key" to xApiKey)
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getLatestEmail(inboxIds: kotlin.collections.Set<java.util.UUID>?) : Email {
    ...
    * @return RequestConfig
    */
    fun getLatestEmailRequestConfig(inboxIds: kotlin.collections.Set<java.util.UUID>?) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (inboxIds != null) {
