...
class EmailControllerApi(private val xApiKey: kotlin.String, basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun sendEmailSourceOptional(inboxId: java.util.UUID, sendEmailOptions: SendEmailOptions, useDomainPool: kotlin.Boolean?) : Unit {
        val localVariableConfig = sendEmailSourceOptionalRequestConfig(inboxId = inboxId, sendEmailOptions = sendEmailOptions, useDomainPool = useDomainPool)
    ...
    * @return RequestConfig
    */
    fun sendEmailSourceOptionalRequestConfig(inboxId: java.util.UUID, sendEmailOptions: SendEmailOptions, useDomainPool: kotlin.Boolean?) : RequestConfig {
