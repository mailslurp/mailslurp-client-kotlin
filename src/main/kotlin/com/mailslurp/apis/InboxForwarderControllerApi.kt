...
class InboxForwarderControllerApi(private val xApiKey: kotlin.String, basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    ...
    fun createNewInboxForwarder(createInboxForwarderOptions: CreateInboxForwarderOptions, inboxId: java.util.UUID?) : InboxForwarderDto {
        val localVariableConfig = createNewInboxForwarderRequestConfig(createInboxForwarderOptions = createInboxForwarderOptions, inboxId = inboxId)
    ...
    */
    fun createNewInboxForwarderRequestConfig(createInboxForwarderOptions: CreateInboxForwarderOptions, inboxId: java.util.UUID?) : RequestConfig {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getInboxForwarders(inboxId: java.util.UUID?, page: kotlin.Int?, searchFilter: kotlin.String?, size: kotlin.Int?, sort: kotlin.String?) : PageInboxForwarderDto {
        val localVariableConfig = getInboxForwardersRequestConfig(inboxId = inboxId, page = page, searchFilter = searchFilter, size = size, sort = sort)
    ...
    * @return RequestConfig
    */
    fun getInboxForwardersRequestConfig(inboxId: java.util.UUID?, page: kotlin.Int?, searchFilter: kotlin.String?, size: kotlin.Int?, sort: kotlin.String?) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (inboxId != null) {
