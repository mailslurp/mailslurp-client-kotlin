...
class ApiUserControllerApi(private val xApiKey: kotlin.String, basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    ...
    fun getSmtpPassword() : kotlin.String {
        val localVariableConfig = getSmtpPasswordRequestConfig()
    ...
    */
    fun getSmtpPasswordRequestConfig() : RequestConfig {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getSmtpUsername() : kotlin.String {
        val localVariableConfig = getSmtpUsernameRequestConfig()
    ...
    * @return RequestConfig
    */
    fun getSmtpUsernameRequestConfig() : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("x-api-key" to xApiKey)
