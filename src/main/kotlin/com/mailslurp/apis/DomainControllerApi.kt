...
class DomainControllerApi(private val xApiKey: kotlin.String, basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    ...
    fun createDomain(domainOptions: CreateDomainOptions) : DomainDto {
        val localVariableConfig = createDomainRequestConfig(domainOptions = domainOptions)
    ...
    * @return RequestConfig
    */
    fun createDomainRequestConfig(domainOptions: CreateDomainOptions) : RequestConfig {
    ...
    */
    ...
    fun updateDomain(id: java.util.UUID, updateDomainDto: UpdateDomainOptions) : DomainDto {
        val localVariableConfig = updateDomainRequestConfig(id = id, updateDomainDto = updateDomainDto)
    ...
    * @return RequestConfig
    */
    fun updateDomainRequestConfig(id: java.util.UUID, updateDomainDto: UpdateDomainOptions) : RequestConfig {
