...
class TemplateControllerApi(private val xApiKey: kotlin.String, basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getTemplatePreviewHtml(templateId: java.util.UUID) : kotlin.String {
        val localVariableConfig = getTemplatePreviewHtmlRequestConfig(templateId = templateId)
    ...
    * @return RequestConfig
    */
    fun getTemplatePreviewHtmlRequestConfig(templateId: java.util.UUID) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("x-api-key" to xApiKey)
        ...
        val localVariableConfig = RequestConfig(
            method = RequestMethod.GET,
            path = "/templates/{templateId}/preview/html".replace("{"+"templateId"+"}", "$templateId"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getTemplatePreviewJson(templateId: java.util.UUID) : TemplatePreview {
        val localVariableConfig = getTemplatePreviewJsonRequestConfig(templateId = templateId)

        val localVarResponse = request<TemplatePreview>(
            localVariableConfig
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as TemplatePreview
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    * @return RequestConfig
    */
    fun getTemplatePreviewJsonRequestConfig(templateId: java.util.UUID) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("x-api-key" to xApiKey)
        ...
        val localVariableConfig = RequestConfig(
            method = RequestMethod.GET,
            path = "/templates/{templateId}/preview/json".replace("{"+"templateId"+"}", "$templateId"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
