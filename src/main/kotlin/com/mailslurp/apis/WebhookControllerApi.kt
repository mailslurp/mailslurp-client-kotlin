...
class WebhookControllerApi(private val xApiKey: kotlin.String, basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    ...
    fun createAccountWebhook(createWebhookOptions: CreateWebhookOptions) : WebhookDto {
        val localVariableConfig = createAccountWebhookRequestConfig(createWebhookOptions = createWebhookOptions)
    ...
    */
    fun createAccountWebhookRequestConfig(createWebhookOptions: CreateWebhookOptions) : RequestConfig {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun createWebhookForPhoneNumber(phoneNumberId: java.util.UUID, createWebhookOptions: CreateWebhookOptions) : WebhookDto {
        val localVariableConfig = createWebhookForPhoneNumberRequestConfig(phoneNumberId = phoneNumberId, createWebhookOptions = createWebhookOptions)
    ...
    /**
    * To obtain the request config of the operation createWebhookForPhoneNumber
    *
    * @param phoneNumberId  
    * @param createWebhookOptions  
    * @return RequestConfig
    */
    fun createWebhookForPhoneNumberRequestConfig(phoneNumberId: java.util.UUID, createWebhookOptions: CreateWebhookOptions) : RequestConfig {
        val localVariableBody: kotlin.Any? = createWebhookOptions
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("x-api-key" to xApiKey)
        ...
        val localVariableConfig = RequestConfig(
            method = RequestMethod.POST,
            path = "/phone/numbers/{phoneNumberId}/webhooks".replace("{"+"phoneNumberId"+"}", "$phoneNumberId"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
    ...
    */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun deleteAllWebhooks(before: java.time.OffsetDateTime?) : Unit {
        val localVariableConfig = deleteAllWebhooksRequestConfig(before = before)
    ...
    * @return RequestConfig
    */
    fun deleteAllWebhooksRequestConfig(before: java.time.OffsetDateTime?) : RequestConfig {
    ...
    */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun deleteWebhookById(webhookId: java.util.UUID) : Unit {
        val localVariableConfig = deleteWebhookByIdRequestConfig(webhookId = webhookId)
    ...
    * @return RequestConfig
    */
    fun deleteWebhookByIdRequestConfig(webhookId: java.util.UUID) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("x-api-key" to xApiKey)
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getAllAccountWebhooks(page: kotlin.Int?, size: kotlin.Int?, sort: kotlin.String?, eventType: kotlin.String?, since: java.time.OffsetDateTime?, before: java.time.OffsetDateTime?) : PageWebhookProjection {
        val localVariableConfig = getAllAccountWebhooksRequestConfig(page = page, size = size, sort = sort, eventType = eventType, since = since, before = before)
    ...
    /**
    * To obtain the request config of the operation getAllAccountWebhooks
    *
    * @param page Optional page index in list pagination (optional, default to 0)
    * @param size Optional page size for paginated result list. (optional, default to 20)
    * @param sort Optional createdAt sort direction ASC or DESC (optional, default to DESC)
    ...
    * @return RequestConfig
    */
    fun getAllAccountWebhooksRequestConfig(page: kotlin.Int?, size: kotlin.Int?, sort: kotlin.String?, eventType: kotlin.String?, since: java.time.OffsetDateTime?, before: java.time.OffsetDateTime?) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (page != null) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getAllWebhooks(page: kotlin.Int?, size: kotlin.Int?, sort: kotlin.String?, searchFilter: kotlin.String?, since: java.time.OffsetDateTime?, inboxId: java.util.UUID?, phoneId: java.util.UUID?, before: java.time.OffsetDateTime?) : PageWebhookProjection {
        val localVariableConfig = getAllWebhooksRequestConfig(page = page, size = size, sort = sort, searchFilter = searchFilter, since = since, inboxId = inboxId, phoneId = phoneId, before = before)
    ...
    * @return RequestConfig
    */
    fun getAllWebhooksRequestConfig(page: kotlin.Int?, size: kotlin.Int?, sort: kotlin.String?, searchFilter: kotlin.String?, since: java.time.OffsetDateTime?, inboxId: java.util.UUID?, phoneId: java.util.UUID?, before: java.time.OffsetDateTime?) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (page != null) {
                ...
                if (phoneId != null) {
                    put("phoneId", listOf(phoneId.toString()))
                }
                if (before != null) {
                    put("before", listOf(parseDateToQueryString(before)))
                }
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getJsonSchemaForWebhookEvent(event: kotlin.String) : JSONSchemaDto {
        val localVariableConfig = getJsonSchemaForWebhookEventRequestConfig(event = event)
    ...
    /**
    * To obtain the request config of the operation getJsonSchemaForWebhookEvent
    *
    * @param event  
    * @return RequestConfig
    */
    fun getJsonSchemaForWebhookEventRequestConfig(event: kotlin.String) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getPhoneNumberWebhooksPaginated(phoneId: java.util.UUID, page: kotlin.Int?, size: kotlin.Int?, sort: kotlin.String?, since: java.time.OffsetDateTime?, before: java.time.OffsetDateTime?) : PageWebhookProjection {
        val localVariableConfig = getPhoneNumberWebhooksPaginatedRequestConfig(phoneId = phoneId, page = page, size = size, sort = sort, since = since, before = before)
    ...
    /**
    * To obtain the request config of the operation getPhoneNumberWebhooksPaginated
    *
    * @param phoneId  
    * @param page Optional page index in list pagination (optional, default to 0)
    * @param size Optional page size in list pagination (optional, default to 20)
    ...
    * @return RequestConfig
    */
    fun getPhoneNumberWebhooksPaginatedRequestConfig(phoneId: java.util.UUID, page: kotlin.Int?, size: kotlin.Int?, sort: kotlin.String?, since: java.time.OffsetDateTime?, before: java.time.OffsetDateTime?) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (page != null) {
        ...
        val localVariableConfig = RequestConfig(
            method = RequestMethod.GET,
            path = "/phone/numbers/{phoneId}/webhooks/paginated".replace("{"+"phoneId"+"}", "$phoneId"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getTestWebhookPayloadBounce() : WebhookBouncePayload {
        val localVariableConfig = getTestWebhookPayloadBounceRequestConfig()

        val localVarResponse = request<WebhookBouncePayload>(
            localVariableConfig
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as WebhookBouncePayload
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    /**
    * To obtain the request config of the operation getTestWebhookPayloadBounce
    *
    * @return RequestConfig
    */
    fun getTestWebhookPayloadBounceRequestConfig() : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("x-api-key" to xApiKey)
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getTestWebhookPayloadBounceRecipient() : WebhookBounceRecipientPayload {
        val localVariableConfig = getTestWebhookPayloadBounceRecipientRequestConfig()

        val localVarResponse = request<WebhookBounceRecipientPayload>(
            localVariableConfig
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as WebhookBounceRecipientPayload
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    /**
    * To obtain the request config of the operation getTestWebhookPayloadBounceRecipient
    *
    * @return RequestConfig
    */
    fun getTestWebhookPayloadBounceRecipientRequestConfig() : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("x-api-key" to xApiKey)
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getTestWebhookPayloadDeliveryStatus() : WebhookDeliveryStatusPayload {
        val localVariableConfig = getTestWebhookPayloadDeliveryStatusRequestConfig()

        val localVarResponse = request<WebhookDeliveryStatusPayload>(
            localVariableConfig
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as WebhookDeliveryStatusPayload
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    /**
    * To obtain the request config of the operation getTestWebhookPayloadDeliveryStatus
    *
    * @return RequestConfig
    */
    fun getTestWebhookPayloadDeliveryStatusRequestConfig() : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("x-api-key" to xApiKey)
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getTestWebhookPayloadNewSms() : WebhookNewSmsPayload {
        val localVariableConfig = getTestWebhookPayloadNewSmsRequestConfig()

        val localVarResponse = request<WebhookNewSmsPayload>(
            localVariableConfig
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as WebhookNewSmsPayload
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    /**
    * To obtain the request config of the operation getTestWebhookPayloadNewSms
    *
    * @return RequestConfig
    */
    fun getTestWebhookPayloadNewSmsRequestConfig() : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("x-api-key" to xApiKey)
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getWebhookResultsUnseenErrorCount() : UnseenErrorCountDto {
        val localVariableConfig = getWebhookResultsUnseenErrorCountRequestConfig()
    ...
    * @return RequestConfig
    */
    fun getWebhookResultsUnseenErrorCountRequestConfig() : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("x-api-key" to xApiKey)
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun updateWebhookHeaders(webhookId: java.util.UUID, webhookHeaders: WebhookHeaders) : WebhookDto {
        val localVariableConfig = updateWebhookHeadersRequestConfig(webhookId = webhookId, webhookHeaders = webhookHeaders)
    ...
    /**
    * To obtain the request config of the operation updateWebhookHeaders
    *
    * @param webhookId  
    * @param webhookHeaders  
    * @return RequestConfig
    */
    fun updateWebhookHeadersRequestConfig(webhookId: java.util.UUID, webhookHeaders: WebhookHeaders) : RequestConfig {
        val localVariableBody: kotlin.Any? = webhookHeaders
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("x-api-key" to xApiKey)
        
        val localVariableConfig = RequestConfig(
            method = RequestMethod.PUT,
            path = "/webhooks/{webhookId}/headers".replace("{"+"webhookId"+"}", "$webhookId"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun verifyWebhookSignature(verifyWebhookSignatureOptions: VerifyWebhookSignatureOptions) : VerifyWebhookSignatureResults {
        val localVariableConfig = verifyWebhookSignatureRequestConfig(verifyWebhookSignatureOptions = verifyWebhookSignatureOptions)

        val localVarResponse = request<VerifyWebhookSignatureResults>(
            localVariableConfig
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as VerifyWebhookSignatureResults
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    /**
    * To obtain the request config of the operation verifyWebhookSignature
    *
    * @param verifyWebhookSignatureOptions  
    * @return RequestConfig
    */
    fun verifyWebhookSignatureRequestConfig(verifyWebhookSignatureOptions: VerifyWebhookSignatureOptions) : RequestConfig {
        val localVariableBody: kotlin.Any? = verifyWebhookSignatureOptions
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("x-api-key" to xApiKey)
