...
class WebhookControllerApi(private val xApiKey: kotlin.String, basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getAllWebhookResults(page: kotlin.Int?, size: kotlin.Int?, sort: kotlin.String?) : PageWebhookResult {
        val localVariableConfig = getAllWebhookResultsRequestConfig(page = page, size = size, sort = sort)
    ...
    * @return RequestConfig
    */
    fun getAllWebhookResultsRequestConfig(page: kotlin.Int?, size: kotlin.Int?, sort: kotlin.String?) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getWebhookResults(webhookId: java.util.UUID, page: kotlin.Int?, size: kotlin.Int?, sort: kotlin.String?) : PageWebhookResult {
        val localVariableConfig = getWebhookResultsRequestConfig(webhookId = webhookId, page = page, size = size, sort = sort)
    ...
    * @return RequestConfig
    */
    fun getWebhookResultsRequestConfig(webhookId: java.util.UUID, page: kotlin.Int?, size: kotlin.Int?, sort: kotlin.String?) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (page != null) {
