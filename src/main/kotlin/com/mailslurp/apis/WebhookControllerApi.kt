...
class WebhookControllerApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    companion object {
        @JvmStatic
    ...
    */
    ...
    fun createWebhook(inboxId: java.util.UUID, webhookOptions: CreateWebhookOptions) : WebhookDto {
        ...
        val localVariableConfig = RequestConfig(
            RequestMethod.POST,
            "/inboxes/{inboxId}/webhooks".replace("{"+"inboxId"+"}", "$inboxId"),
    ...
    */
    ...
    fun deleteWebhook(inboxId: java.util.UUID, webhookId: java.util.UUID) : Unit {
        ...
        val localVariableConfig = RequestConfig(
            ...
            "/inboxes/{inboxId}/webhooks/{webhookId}".replace("{"+"inboxId"+"}", "$inboxId").replace("{"+"webhookId"+"}", "$webhookId"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
    ...
    * 
    * @param inboxId inboxId 
    * @return kotlin.Array<WebhookDto>
    * @throws UnsupportedOperationException If the API returns an informational or redirection response
    * @throws ClientException If the API returns a client error response
    * @throws ServerException If the API returns a server error response
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getWebhooks(inboxId: java.util.UUID) : kotlin.Array<WebhookDto> {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        val localVariableConfig = RequestConfig(
        ...
        val localVarResponse = request<kotlin.Array<WebhookDto>>(
            localVariableConfig,
            localVariableBody
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as kotlin.Array<WebhookDto>
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    */
    ...
    fun sendTestData(webhookId: java.util.UUID) : WebhookTestResult {
        ...
        val localVariableConfig = RequestConfig(
            RequestMethod.POST,
            "/webhooks/{webhookId}/test".replace("{"+"webhookId"+"}", "$webhookId"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
