...
class ExpiredControllerApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    companion object {
        @JvmStatic
    ...
    */
    ...
    fun getExpiredInboxByInboxId(inboxId: java.util.UUID) : ExpiredInboxDto {
        ...
        val localVariableConfig = RequestConfig(
            RequestMethod.GET,
            "/expired/inbox/{inboxId}".replace("{"+"inboxId"+"}", "$inboxId"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
    ...
    */
    ...
    fun getExpiredInboxRecord(expiredId: java.util.UUID) : ExpiredInboxDto {
        ...
        val localVariableConfig = RequestConfig(
            RequestMethod.GET,
            "/expired/{expiredId}".replace("{"+"expiredId"+"}", "$expiredId"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
        val localVarResponse = request<ExpiredInboxDto>(
