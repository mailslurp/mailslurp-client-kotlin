...
class ExpiredControllerApi(private val xApiKey: kotlin.String, basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getExpiredInboxes(before: java.time.OffsetDateTime?, page: kotlin.Int?, since: java.time.OffsetDateTime?, size: kotlin.Int?, sort: kotlin.String?) : PageExpiredInboxRecordProjection {
        val localVariableConfig = getExpiredInboxesRequestConfig(before = before, page = page, since = since, size = size, sort = sort)
    ...
    * @return RequestConfig
    */
    fun getExpiredInboxesRequestConfig(before: java.time.OffsetDateTime?, page: kotlin.Int?, since: java.time.OffsetDateTime?, size: kotlin.Int?, sort: kotlin.String?) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
