...
class AliasControllerApi(private val xApiKey: kotlin.String, basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getAliasEmails(aliasId: java.util.UUID, before: java.time.OffsetDateTime?, page: kotlin.Int?, since: java.time.OffsetDateTime?, size: kotlin.Int?, sort: kotlin.String?) : PageEmailProjection {
        val localVariableConfig = getAliasEmailsRequestConfig(aliasId = aliasId, before = before, page = page, since = since, size = size, sort = sort)
    ...
    * @return RequestConfig
    */
    fun getAliasEmailsRequestConfig(aliasId: java.util.UUID, before: java.time.OffsetDateTime?, page: kotlin.Int?, since: java.time.OffsetDateTime?, size: kotlin.Int?, sort: kotlin.String?) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getAliasThreads(aliasId: java.util.UUID, before: java.time.OffsetDateTime?, page: kotlin.Int?, since: java.time.OffsetDateTime?, size: kotlin.Int?, sort: kotlin.String?) : PageThreadProjection {
        val localVariableConfig = getAliasThreadsRequestConfig(aliasId = aliasId, before = before, page = page, since = since, size = size, sort = sort)
    ...
    * @return RequestConfig
    */
    fun getAliasThreadsRequestConfig(aliasId: java.util.UUID, before: java.time.OffsetDateTime?, page: kotlin.Int?, since: java.time.OffsetDateTime?, size: kotlin.Int?, sort: kotlin.String?) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (before != null) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getAliases(before: java.time.OffsetDateTime?, page: kotlin.Int?, since: java.time.OffsetDateTime?, size: kotlin.Int?, sort: kotlin.String?) : PageAlias {
        val localVariableConfig = getAliasesRequestConfig(before = before, page = page, since = since, size = size, sort = sort)
    ...
    * @return RequestConfig
    */
    fun getAliasesRequestConfig(before: java.time.OffsetDateTime?, page: kotlin.Int?, since: java.time.OffsetDateTime?, size: kotlin.Int?, sort: kotlin.String?) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (before != null) {
