...
class InboxRulesetControllerApi(private val xApiKey: kotlin.String, basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    ...
    fun createNewInboxRuleset(createInboxRulesetOptions: CreateInboxRulesetOptions, inboxId: java.util.UUID?) : InboxRulesetDto {
        val localVariableConfig = createNewInboxRulesetRequestConfig(createInboxRulesetOptions = createInboxRulesetOptions, inboxId = inboxId)
    ...
    */
    fun createNewInboxRulesetRequestConfig(createInboxRulesetOptions: CreateInboxRulesetOptions, inboxId: java.util.UUID?) : RequestConfig {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getInboxRulesets(inboxId: java.util.UUID?, page: kotlin.Int?, size: kotlin.Int?, sort: kotlin.String?) : PageInboxRulesetProjection {
        val localVariableConfig = getInboxRulesetsRequestConfig(inboxId = inboxId, page = page, size = size, sort = sort)

        val localVarResponse = request<PageInboxRulesetProjection>(
            localVariableConfig
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as PageInboxRulesetProjection
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    * @return RequestConfig
    */
    fun getInboxRulesetsRequestConfig(inboxId: java.util.UUID?, page: kotlin.Int?, size: kotlin.Int?, sort: kotlin.String?) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (inboxId != null) {
