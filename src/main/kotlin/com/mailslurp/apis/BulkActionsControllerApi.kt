...
class BulkActionsControllerApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    companion object {
        @JvmStatic
    ...
    */
    ...
    fun bulkCreateInboxes(count: kotlin.Int) : kotlin.Array<Inbox> {
    ...
    */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun bulkDeleteInboxes(ids: kotlin.Array<java.util.UUID>) : Unit {
