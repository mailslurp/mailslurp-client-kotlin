...
class BulkActionsControllerApi(private val xApiKey: kotlin.String, basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    ...
    fun bulkCreateInboxes(count: kotlin.Int) : kotlin.collections.List<Inbox> {
    ...
    */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun bulkDeleteInboxes(ids: kotlin.collections.List<java.util.UUID>) : Unit {
        val localVariableConfig = bulkDeleteInboxesRequestConfig(ids = ids)
    ...
    * @return RequestConfig
    */
    fun bulkDeleteInboxesRequestConfig(ids: kotlin.collections.List<java.util.UUID>) : RequestConfig {
