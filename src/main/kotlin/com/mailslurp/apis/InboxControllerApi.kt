...
class InboxControllerApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    companion object {
        @JvmStatic
    ...
    */
    ...
    fun createInbox(allowTeamAccess: kotlin.Boolean?, description: kotlin.String?, emailAddress: kotlin.String?, expiresAt: java.time.OffsetDateTime?, expiresIn: kotlin.Long?, favourite: kotlin.Boolean?, name: kotlin.String?, tags: kotlin.Array<kotlin.String>?, useDomainPool: kotlin.Boolean?) : Inbox {
    ...
    */
    ...
    fun deleteInbox(inboxId: java.util.UUID) : Unit {
        ...
        val localVariableConfig = RequestConfig(
            RequestMethod.DELETE,
            "/inboxes/{inboxId}".replace("{"+"inboxId"+"}", "$inboxId"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
        val localVarResponse = request<Any?>(
    ...
    * @return kotlin.Array<EmailPreview>
    * @throws UnsupportedOperationException If the API returns an informational or redirection response
    * @throws ClientException If the API returns a client error response
    * @throws ServerException If the API returns a server error response
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getEmails(inboxId: java.util.UUID, limit: kotlin.Int?, minCount: kotlin.Long?, retryTimeout: kotlin.Long?, since: java.time.OffsetDateTime?, size: kotlin.Int?, sort: kotlin.String?) : kotlin.Array<EmailPreview> {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (limit != null) {
        ...
        val localVariableConfig = RequestConfig(
            RequestMethod.GET,
            "/inboxes/{inboxId}/emails".replace("{"+"inboxId"+"}", "$inboxId"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
        val localVarResponse = request<kotlin.Array<EmailPreview>>(
            localVariableConfig,
            localVariableBody
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as kotlin.Array<EmailPreview>
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    */
    ...
    fun getInboxEmailsPaginated(inboxId: java.util.UUID, page: kotlin.Int?, size: kotlin.Int?, sort: kotlin.String?) : PageEmailPreview {
        ...
        val localVariableConfig = RequestConfig(
            RequestMethod.GET,
            "/inboxes/{inboxId}/emails/paginated".replace("{"+"inboxId"+"}", "$inboxId"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
    ...
    */
    ...
    fun getInboxSentEmails(inboxId: java.util.UUID, page: kotlin.Int?, size: kotlin.Int?, sort: kotlin.String?) : PageSentEmailProjection {
        ...
        val localVariableConfig = RequestConfig(
            RequestMethod.GET,
            "/inboxes/{inboxId}/sent".replace("{"+"inboxId"+"}", "$inboxId"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getInboxTags() : kotlin.Array<kotlin.String> {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        val localVariableConfig = RequestConfig(
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getInboxes(size: kotlin.Int?, sort: kotlin.String?) : kotlin.Array<Inbox> {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (size != null) {
        ...
        val localVarResponse = request<kotlin.Array<Inbox>>(
            localVariableConfig,
            localVariableBody
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as kotlin.Array<Inbox>
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    */
    ...
    fun sendEmailAndConfirm(inboxId: java.util.UUID, sendEmailOptions: SendEmailOptions?) : SentEmailDto {
        ...
        val localVariableConfig = RequestConfig(
            RequestMethod.POST,
            "/inboxes/{inboxId}/confirm".replace("{"+"inboxId"+"}", "$inboxId"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
    ...
    */
    ...
    fun setInboxFavourited(inboxId: java.util.UUID, setInboxFavouritedOptions: SetInboxFavouritedOptions) : Inbox {
        ...
        val localVariableConfig = RequestConfig(
            RequestMethod.PUT,
            "/inboxes/{inboxId}/favourite".replace("{"+"inboxId"+"}", "$inboxId"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
        val localVarResponse = request<Inbox>(
