...
class InboxControllerApi(private val xApiKey: kotlin.String, basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getAllInboxes(page: kotlin.Int?, size: kotlin.Int?, sort: kotlin.String?, favourite: kotlin.Boolean?, search: kotlin.String?, tag: kotlin.String?, teamAccess: kotlin.Boolean?, since: java.time.OffsetDateTime?, before: java.time.OffsetDateTime?) : PageInboxProjection {
        val localVariableConfig = getAllInboxesRequestConfig(page = page, size = size, sort = sort, favourite = favourite, search = search, tag = tag, teamAccess = teamAccess, since = since, before = before)
    ...
    * @return RequestConfig
    */
    fun getAllInboxesRequestConfig(page: kotlin.Int?, size: kotlin.Int?, sort: kotlin.String?, favourite: kotlin.Boolean?, search: kotlin.String?, tag: kotlin.String?, teamAccess: kotlin.Boolean?, since: java.time.OffsetDateTime?, before: java.time.OffsetDateTime?) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (page != null) {
