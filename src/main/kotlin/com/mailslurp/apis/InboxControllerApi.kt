...
class InboxControllerApi(private val xApiKey: kotlin.String, basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    ...
    fun createInbox(emailAddress: kotlin.String?, tags: kotlin.collections.List<kotlin.String>?, name: kotlin.String?, description: kotlin.String?, useDomainPool: kotlin.Boolean?, favourite: kotlin.Boolean?, expiresAt: java.time.OffsetDateTime?, expiresIn: kotlin.Long?, allowTeamAccess: kotlin.Boolean?, inboxType: kotlin.String?) : InboxDto {
        val localVariableConfig = createInboxRequestConfig(emailAddress = emailAddress, tags = tags, name = name, description = description, useDomainPool = useDomainPool, favourite = favourite, expiresAt = expiresAt, expiresIn = expiresIn, allowTeamAccess = allowTeamAccess, inboxType = inboxType)
    ...
    */
    fun createInboxRequestConfig(emailAddress: kotlin.String?, tags: kotlin.collections.List<kotlin.String>?, name: kotlin.String?, description: kotlin.String?, useDomainPool: kotlin.Boolean?, favourite: kotlin.Boolean?, expiresAt: java.time.OffsetDateTime?, expiresIn: kotlin.Long?, allowTeamAccess: kotlin.Boolean?, inboxType: kotlin.String?) : RequestConfig {
