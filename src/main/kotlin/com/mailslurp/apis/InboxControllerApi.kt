...
class InboxControllerApi(private val xApiKey: kotlin.String, basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getEmails(inboxId: java.util.UUID, aliasForLimitAssessedFirstBeforeAssessingAnyPassedLimit: kotlin.Int?, limit: kotlin.Int?, sortTheResultsByReceivedDateAndDirectionASCOrDESC: kotlin.String?, retryTimeout: kotlin.Long?, delayTimeout: kotlin.Long?, minCount: kotlin.Long?, unreadOnly: kotlin.Boolean?, before: java.time.OffsetDateTime?, since: java.time.OffsetDateTime?) : kotlin.collections.List<EmailPreview> {
        val localVariableConfig = getEmailsRequestConfig(inboxId = inboxId, aliasForLimitAssessedFirstBeforeAssessingAnyPassedLimit = aliasForLimitAssessedFirstBeforeAssessingAnyPassedLimit, limit = limit, sortTheResultsByReceivedDateAndDirectionASCOrDESC = sortTheResultsByReceivedDateAndDirectionASCOrDESC, retryTimeout = retryTimeout, delayTimeout = delayTimeout, minCount = minCount, unreadOnly = unreadOnly, before = before, since = since)
    ...
    * @return RequestConfig
    */
    fun getEmailsRequestConfig(inboxId: java.util.UUID, aliasForLimitAssessedFirstBeforeAssessingAnyPassedLimit: kotlin.Int?, limit: kotlin.Int?, sortTheResultsByReceivedDateAndDirectionASCOrDESC: kotlin.String?, retryTimeout: kotlin.Long?, delayTimeout: kotlin.Long?, minCount: kotlin.Long?, unreadOnly: kotlin.Boolean?, before: java.time.OffsetDateTime?, since: java.time.OffsetDateTime?) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
