...
class InboxControllerApi(private val xApiKey: kotlin.String, basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getAllScheduledJobs(page: kotlin.Int?, size: kotlin.Int?, sort: kotlin.String?, since: java.time.OffsetDateTime?, before: java.time.OffsetDateTime?) : PageScheduledJobs {
        val localVariableConfig = getAllScheduledJobsRequestConfig(page = page, size = size, sort = sort, since = since, before = before)

        val localVarResponse = request<PageScheduledJobs>(
            localVariableConfig
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as PageScheduledJobs
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    /**
    * To obtain the request config of the operation getAllScheduledJobs
    *
    * @param page Optional page index in scheduled job list pagination (optional, default to 0)
    * @param size Optional page size in scheduled job list pagination (optional, default to 20)
    * @param sort Optional createdAt sort direction ASC or DESC (optional, default to ASC)
    ...
    * @return RequestConfig
    */
    fun getAllScheduledJobsRequestConfig(page: kotlin.Int?, size: kotlin.Int?, sort: kotlin.String?, since: java.time.OffsetDateTime?, before: java.time.OffsetDateTime?) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (page != null) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getScheduledJobsByInboxId(inboxId: java.util.UUID, page: kotlin.Int?, size: kotlin.Int?, sort: kotlin.String?, since: java.time.OffsetDateTime?, before: java.time.OffsetDateTime?) : PageScheduledJobs {
        val localVariableConfig = getScheduledJobsByInboxIdRequestConfig(inboxId = inboxId, page = page, size = size, sort = sort, since = since, before = before)
    ...
    /**
    * To obtain the request config of the operation getScheduledJobsByInboxId
    *
    * @param inboxId  
    * @param page Optional page index in scheduled job list pagination (optional, default to 0)
    * @param size Optional page size in scheduled job list pagination (optional, default to 20)
    ...
    * @return RequestConfig
    */
    fun getScheduledJobsByInboxIdRequestConfig(inboxId: java.util.UUID, page: kotlin.Int?, size: kotlin.Int?, sort: kotlin.String?, since: java.time.OffsetDateTime?, before: java.time.OffsetDateTime?) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (page != null) {
        ...
        val localVariableConfig = RequestConfig(
            method = RequestMethod.GET,
            path = "/inboxes/{inboxId}/scheduled-jobs".replace("{"+"inboxId"+"}", "$inboxId"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
    ...
    */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun sendWithSchedule(inboxId: java.util.UUID, sendEmailOptions: SendEmailOptions, sendAtTimestamp: java.time.OffsetDateTime?, sendAtNowPlusSeconds: kotlin.Long?, validateBeforeEnqueue: kotlin.Boolean?) : Unit {
        val localVariableConfig = sendWithScheduleRequestConfig(inboxId = inboxId, sendEmailOptions = sendEmailOptions, sendAtTimestamp = sendAtTimestamp, sendAtNowPlusSeconds = sendAtNowPlusSeconds, validateBeforeEnqueue = validateBeforeEnqueue)
    ...
    /**
    * To obtain the request config of the operation sendWithSchedule
    *
    * @param inboxId ID of the inbox you want to send the email from 
    * @param sendEmailOptions  
    * @param sendAtTimestamp Sending timestamp (optional)
    ...
    * @return RequestConfig
    */
    fun sendWithScheduleRequestConfig(inboxId: java.util.UUID, sendEmailOptions: SendEmailOptions, sendAtTimestamp: java.time.OffsetDateTime?, sendAtNowPlusSeconds: kotlin.Long?, validateBeforeEnqueue: kotlin.Boolean?) : RequestConfig {
        val localVariableBody: kotlin.Any? = sendEmailOptions
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (sendAtTimestamp != null) {
                    put("sendAtTimestamp", listOf(parseDateToQueryString(sendAtTimestamp)))
                }
                if (sendAtNowPlusSeconds != null) {
                    put("sendAtNowPlusSeconds", listOf(sendAtNowPlusSeconds.toString()))
                }
        ...
        val localVariableConfig = RequestConfig(
            method = RequestMethod.POST,
            path = "/inboxes/{inboxId}/with-schedule".replace("{"+"inboxId"+"}", "$inboxId"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
