...
class InboxControllerApi(private val xApiKey: kotlin.String, basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    ...
    fun createInbox(allowTeamAccess: kotlin.Boolean?, description: kotlin.String?, emailAddress: kotlin.String?, expiresAt: java.time.OffsetDateTime?, expiresIn: kotlin.Long?, favourite: kotlin.Boolean?, name: kotlin.String?, tags: kotlin.collections.List<kotlin.String>?, useDomainPool: kotlin.Boolean?) : Inbox {
        val localVariableConfig = createInboxRequestConfig(allowTeamAccess = allowTeamAccess, description = description, emailAddress = emailAddress, expiresAt = expiresAt, expiresIn = expiresIn, favourite = favourite, name = name, tags = tags, useDomainPool = useDomainPool)
    ...
    */
    fun createInboxRequestConfig(allowTeamAccess: kotlin.Boolean?, description: kotlin.String?, emailAddress: kotlin.String?, expiresAt: java.time.OffsetDateTime?, expiresIn: kotlin.Long?, favourite: kotlin.Boolean?, name: kotlin.String?, tags: kotlin.collections.List<kotlin.String>?, useDomainPool: kotlin.Boolean?) : RequestConfig {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getInboxSentEmails(inboxId: java.util.UUID, page: kotlin.Int?, size: kotlin.Int?, sort: kotlin.String?) : PageSentEmailProjection {
        val localVariableConfig = getInboxSentEmailsRequestConfig(inboxId = inboxId, page = page, size = size, sort = sort)
    ...
    * @return RequestConfig
    */
    fun getInboxSentEmailsRequestConfig(inboxId: java.util.UUID, page: kotlin.Int?, size: kotlin.Int?, sort: kotlin.String?) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (page != null) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getOrganizationInboxes(page: kotlin.Int?, size: kotlin.Int?, sort: kotlin.String?) : PageOrganizationInboxProjection {
        val localVariableConfig = getOrganizationInboxesRequestConfig(page = page, size = size, sort = sort)
    ...
    * @return RequestConfig
    */
    fun getOrganizationInboxesRequestConfig(page: kotlin.Int?, size: kotlin.Int?, sort: kotlin.String?) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (page != null) {
