...
class InboxControllerApi(private val xApiKey: kotlin.String, basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getEmails(inboxId: java.util.UUID, delayTimeout: kotlin.Long?, limit: kotlin.Int?, minCount: kotlin.Long?, retryTimeout: kotlin.Long?, since: java.time.OffsetDateTime?, size: kotlin.Int?, sort: kotlin.String?, unreadOnly: kotlin.Boolean?) : kotlin.collections.List<EmailPreview> {
        val localVariableConfig = getEmailsRequestConfig(inboxId = inboxId, delayTimeout = delayTimeout, limit = limit, minCount = minCount, retryTimeout = retryTimeout, since = since, size = size, sort = sort, unreadOnly = unreadOnly)
    ...
    * @return RequestConfig
    */
    fun getEmailsRequestConfig(inboxId: java.util.UUID, delayTimeout: kotlin.Long?, limit: kotlin.Int?, minCount: kotlin.Long?, retryTimeout: kotlin.Long?, since: java.time.OffsetDateTime?, size: kotlin.Int?, sort: kotlin.String?, unreadOnly: kotlin.Boolean?) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun listInboxRulesets(inboxId: java.util.UUID, page: kotlin.Int?, searchFilter: kotlin.String?, size: kotlin.Int?, sort: kotlin.String?) : PageInboxRulesetDto {
        val localVariableConfig = listInboxRulesetsRequestConfig(inboxId = inboxId, page = page, searchFilter = searchFilter, size = size, sort = sort)
    ...
    * @return RequestConfig
    */
    fun listInboxRulesetsRequestConfig(inboxId: java.util.UUID, page: kotlin.Int?, searchFilter: kotlin.String?, size: kotlin.Int?, sort: kotlin.String?) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (page != null) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun listInboxTrackingPixels(inboxId: java.util.UUID, page: kotlin.Int?, searchFilter: kotlin.String?, size: kotlin.Int?, sort: kotlin.String?) : PageTrackingPixelProjection {
        val localVariableConfig = listInboxTrackingPixelsRequestConfig(inboxId = inboxId, page = page, searchFilter = searchFilter, size = size, sort = sort)
    ...
    * @return RequestConfig
    */
    fun listInboxTrackingPixelsRequestConfig(inboxId: java.util.UUID, page: kotlin.Int?, searchFilter: kotlin.String?, size: kotlin.Int?, sort: kotlin.String?) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (page != null) {
