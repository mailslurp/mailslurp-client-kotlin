...
class AttachmentControllerApi(private val xApiKey: kotlin.String, basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun downloadAttachmentAsBytes(attachmentId: kotlin.String) : kotlin.collections.List<kotlin.ByteArray> {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getAttachments1(page: kotlin.Int?, size: kotlin.Int?, sort: kotlin.String?, fileNameFilter: kotlin.String?, since: java.time.OffsetDateTime?, before: java.time.OffsetDateTime?) : PageAttachmentEntity {
        val localVariableConfig = getAttachments1RequestConfig(page = page, size = size, sort = sort, fileNameFilter = fileNameFilter, since = since, before = before)
    ...
    * @return RequestConfig
    */
    fun getAttachments1RequestConfig(page: kotlin.Int?, size: kotlin.Int?, sort: kotlin.String?, fileNameFilter: kotlin.String?, since: java.time.OffsetDateTime?, before: java.time.OffsetDateTime?) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
