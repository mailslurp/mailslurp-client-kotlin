...
class AttachmentControllerApi(private val xApiKey: kotlin.String, basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getAttachments(before: java.time.OffsetDateTime?, fileNameFilter: kotlin.String?, page: kotlin.Int?, since: java.time.OffsetDateTime?, size: kotlin.Int?, sort: kotlin.String?) : PageAttachmentEntity {
        val localVariableConfig = getAttachmentsRequestConfig(before = before, fileNameFilter = fileNameFilter, page = page, since = since, size = size, sort = sort)
    ...
    * @return RequestConfig
    */
    fun getAttachmentsRequestConfig(before: java.time.OffsetDateTime?, fileNameFilter: kotlin.String?, page: kotlin.Int?, since: java.time.OffsetDateTime?, size: kotlin.Int?, sort: kotlin.String?) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
