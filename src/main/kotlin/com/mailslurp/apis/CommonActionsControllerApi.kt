...
class CommonActionsControllerApi(private val xApiKey: kotlin.String, basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    ...
    fun createNewEmailAddress(allowTeamAccess: kotlin.Boolean?, useDomainPool: kotlin.Boolean?, expiresAt: java.time.OffsetDateTime?, expiresIn: kotlin.Long?, emailAddress: kotlin.String?, inboxType: kotlin.String?, description: kotlin.String?, name: kotlin.String?, tags: kotlin.collections.List<kotlin.String>?, favourite: kotlin.Boolean?) : InboxDto {
    ...
    */
    fun createNewEmailAddressRequestConfig(allowTeamAccess: kotlin.Boolean?, useDomainPool: kotlin.Boolean?, expiresAt: java.time.OffsetDateTime?, expiresIn: kotlin.Long?, emailAddress: kotlin.String?, inboxType: kotlin.String?, description: kotlin.String?, name: kotlin.String?, tags: kotlin.collections.List<kotlin.String>?, favourite: kotlin.Boolean?) : RequestConfig {
    ...
    */
    ...
    fun createRandomInbox(allowTeamAccess: kotlin.Boolean?, useDomainPool: kotlin.Boolean?, expiresAt: java.time.OffsetDateTime?, expiresIn: kotlin.Long?, emailAddress: kotlin.String?, inboxType: kotlin.String?, description: kotlin.String?, name: kotlin.String?, tags: kotlin.collections.List<kotlin.String>?, favourite: kotlin.Boolean?) : InboxDto {
        val localVariableConfig = createRandomInboxRequestConfig(allowTeamAccess = allowTeamAccess, useDomainPool = useDomainPool, expiresAt = expiresAt, expiresIn = expiresIn, emailAddress = emailAddress, inboxType = inboxType, description = description, name = name, tags = tags, favourite = favourite)
