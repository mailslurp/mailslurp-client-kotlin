...
class CommonActionsControllerApi(private val xApiKey: kotlin.String, basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    ...
    fun createNewEmailAddress(allowTeamAccess: kotlin.Boolean?, useDomainPool: kotlin.Boolean?, expiresAt: java.time.OffsetDateTime?, expiresIn: kotlin.Long?, emailAddress: kotlin.String?, inboxType: kotlin.String?, description: kotlin.String?, name: kotlin.String?, tags: kotlin.collections.Set<kotlin.String>?, favourite: kotlin.Boolean?) : InboxDto {
        val localVariableConfig = createNewEmailAddressRequestConfig(allowTeamAccess = allowTeamAccess, useDomainPool = useDomainPool, expiresAt = expiresAt, expiresIn = expiresIn, emailAddress = emailAddress, inboxType = inboxType, description = description, name = name, tags = tags, favourite = favourite)
    ...
    */
    fun createNewEmailAddressRequestConfig(allowTeamAccess: kotlin.Boolean?, useDomainPool: kotlin.Boolean?, expiresAt: java.time.OffsetDateTime?, expiresIn: kotlin.Long?, emailAddress: kotlin.String?, inboxType: kotlin.String?, description: kotlin.String?, name: kotlin.String?, tags: kotlin.collections.Set<kotlin.String>?, favourite: kotlin.Boolean?) : RequestConfig {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun createNewEmailAddress1(allowTeamAccess: kotlin.Boolean?, useDomainPool: kotlin.Boolean?, expiresAt: java.time.OffsetDateTime?, expiresIn: kotlin.Long?, emailAddress: kotlin.String?, inboxType: kotlin.String?, description: kotlin.String?, name: kotlin.String?, tags: kotlin.collections.Set<kotlin.String>?, favourite: kotlin.Boolean?) : InboxDto {
        val localVariableConfig = createNewEmailAddress1RequestConfig(allowTeamAccess = allowTeamAccess, useDomainPool = useDomainPool, expiresAt = expiresAt, expiresIn = expiresIn, emailAddress = emailAddress, inboxType = inboxType, description = description, name = name, tags = tags, favourite = favourite)
    ...
    * @return RequestConfig
    */
    fun createNewEmailAddress1RequestConfig(allowTeamAccess: kotlin.Boolean?, useDomainPool: kotlin.Boolean?, expiresAt: java.time.OffsetDateTime?, expiresIn: kotlin.Long?, emailAddress: kotlin.String?, inboxType: kotlin.String?, description: kotlin.String?, name: kotlin.String?, tags: kotlin.collections.Set<kotlin.String>?, favourite: kotlin.Boolean?) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (allowTeamAccess != null) {
