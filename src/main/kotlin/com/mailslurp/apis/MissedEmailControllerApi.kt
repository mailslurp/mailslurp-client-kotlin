...
class MissedEmailControllerApi(private val xApiKey: kotlin.String, basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    ...
    fun getAllMissedEmails(page: kotlin.Int?, size: kotlin.Int?, sort: kotlin.String?) : PageMissedEmailProjection {
        val localVariableConfig = getAllMissedEmailsRequestConfig(page = page, size = size, sort = sort)
    ...
    */
    fun getAllMissedEmailsRequestConfig(page: kotlin.Int?, size: kotlin.Int?, sort: kotlin.String?) : RequestConfig {
