...
class MissedEmailControllerApi(private val xApiKey: kotlin.String, basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getAllUnknownMissedEmails(inboxId: java.util.UUID?, page: kotlin.Int?, searchFilter: kotlin.String?, size: kotlin.Int?, sort: kotlin.String?) : PageUnknownMissedEmailProjection {
        val localVariableConfig = getAllUnknownMissedEmailsRequestConfig(inboxId = inboxId, page = page, searchFilter = searchFilter, size = size, sort = sort)
    ...
    * @return RequestConfig
    */
    fun getAllUnknownMissedEmailsRequestConfig(inboxId: java.util.UUID?, page: kotlin.Int?, searchFilter: kotlin.String?, size: kotlin.Int?, sort: kotlin.String?) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (inboxId != null) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun waitForNthMissedEmail(inboxId: java.util.UUID?, index: kotlin.Int?, timeout: kotlin.Long?) : MissedEmail {
        val localVariableConfig = waitForNthMissedEmailRequestConfig(inboxId = inboxId, index = index, timeout = timeout)
    ...
    * @return RequestConfig
    */
    fun waitForNthMissedEmailRequestConfig(inboxId: java.util.UUID?, index: kotlin.Int?, timeout: kotlin.Long?) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (inboxId != null) {
