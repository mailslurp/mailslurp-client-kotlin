...
class BounceControllerApi(private val xApiKey: kotlin.String, basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    ...
    fun getBouncedEmail(id: java.util.UUID) : Bounce {
        val localVariableConfig = getBouncedEmailRequestConfig(id = id)

        val localVarResponse = request<Bounce>(
            localVariableConfig
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as Bounce
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getBouncedEmails(page: kotlin.Int?, size: kotlin.Int?, sort: kotlin.String?) : PageBouncedEmail {
        val localVariableConfig = getBouncedEmailsRequestConfig(page = page, size = size, sort = sort)
    ...
    * @return RequestConfig
    */
    fun getBouncedEmailsRequestConfig(page: kotlin.Int?, size: kotlin.Int?, sort: kotlin.String?) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getBouncedRecipient(id: java.util.UUID) : BounceRecipient {
        val localVariableConfig = getBouncedRecipientRequestConfig(id = id)

        val localVarResponse = request<BounceRecipient>(
            localVariableConfig
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as BounceRecipient
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getBouncedRecipients(page: kotlin.Int?, size: kotlin.Int?, sort: kotlin.String?) : PageBouncedRecipients {
        val localVariableConfig = getBouncedRecipientsRequestConfig(page = page, size = size, sort = sort)
    ...
    * @return RequestConfig
    */
    fun getBouncedRecipientsRequestConfig(page: kotlin.Int?, size: kotlin.Int?, sort: kotlin.String?) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (page != null) {
