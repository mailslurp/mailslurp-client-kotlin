...
class BounceControllerApi(private val xApiKey: kotlin.String, basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    ...
    fun getBouncedEmail(id: java.util.UUID) : Unit {
    ...
    */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getBouncedEmail1(id: java.util.UUID) : Unit {
        val localVariableConfig = getBouncedEmail1RequestConfig(id = id)
    ...
    /**
    * To obtain the request config of the operation getBouncedEmail1
    *
    * @param id ID of the bounced recipient 
    * @return RequestConfig
    */
    fun getBouncedEmail1RequestConfig(id: java.util.UUID) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("x-api-key" to xApiKey)
    ...
    */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getBouncedEmails(page: kotlin.Int?, size: kotlin.Int?, sort: kotlin.String?) : Unit {
    ...
    */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getBouncedRecipients(page: kotlin.Int?, size: kotlin.Int?, sort: kotlin.String?) : Unit {
