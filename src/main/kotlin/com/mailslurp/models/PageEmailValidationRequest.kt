...
import com.mailslurp.models.EmailValidationRequest
...
data class PageEmailValidationRequest (
    @Json(name = "content")
    val content: kotlin.collections.List<EmailValidationRequest>? = null,
    @Json(name = "pageable")
