...
data class InboxRulesetProjection (
    @Json(name = "action")
    val action: InboxRulesetProjection.Action,
    @Json(name = "handler")
    val handler: InboxRulesetProjection.Handler,
    @Json(name = "id")
    val id: java.util.UUID,
    @Json(name = "inboxId")
    val inboxId: java.util.UUID,
    @Json(name = "scope")
    val scope: InboxRulesetProjection.Scope,
    @Json(name = "target")
