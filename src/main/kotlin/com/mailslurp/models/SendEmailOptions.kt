...
data class SendEmailOptions (
    ...
    enum class SendStrategy(val value: kotlin.String) {
        @Json(name = "SINGLE_MESSAGE") SINGLE_MESSAGE("SINGLE_MESSAGE");
    }
    /**
     * Validate recipient email addresses before sending
    ...
    enum class ValidateEmailAddresses(val value: kotlin.String) {
        @Json(name = "VALIDATE_FILTER_REMOVE_INVALID") VALIDATE_FILTER_REMOVE_INVALID("VALIDATE_FILTER_REMOVE_INVALID"),
        @Json(name = "VALIDATE_ERROR_IF_INVALID") VALIDATE_ERROR_IF_INVALID("VALIDATE_ERROR_IF_INVALID"),
        @Json(name = "NO_VALIDATION") NO_VALIDATION("NO_VALIDATION");
    }
}
