...
data class SendEmailOptions (
    ...
    /**
     * Validate recipient email addresses before sending
     * Values: vALIDATEFILTERREMOVEINVALID,vALIDATEERRORIFINVALID,nOVALIDATION
     */
    enum class ValidateEmailAddresses(val value: kotlin.String) {
        @Json(name = "VALIDATE_FILTER_REMOVE_INVALID") vALIDATEFILTERREMOVEINVALID("VALIDATE_FILTER_REMOVE_INVALID"),
        @Json(name = "VALIDATE_ERROR_IF_INVALID") vALIDATEERRORIFINVALID("VALIDATE_ERROR_IF_INVALID"),
        @Json(name = "NO_VALIDATION") nOVALIDATION("NO_VALIDATION");
    }
}
