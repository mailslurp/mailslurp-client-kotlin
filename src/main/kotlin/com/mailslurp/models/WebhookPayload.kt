 ...
 * @param emailId ID of the email that was received. Use this ID for fetching the email
 * @param eventName Name of the event type webhook is being triggered for
 * @param from Who the email was sent from
 * @param id Idempotent message ID. Store this ID locally or in a database to prevent message duplication.
 * @param inboxId Id of the inbox that receive an email
...
data class WebhookPayload (
    ...
    @Json(name = "eventName")
    val eventName: WebhookPayload.EventName? = null,
