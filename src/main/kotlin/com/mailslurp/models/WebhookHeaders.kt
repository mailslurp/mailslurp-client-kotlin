 ...
 * @param headers List of header name value pairs to include with webhook requests
 */

data class WebhookHeaders (
    /* List of header name value pairs to include with webhook requests */
    @SerializedName("headers")
    val headers: kotlin.collections.List<WebhookHeaderNameValue>
)
